...
def main(args):
        ...
        genetomfile = cl.defaultdict(list)
        for mfile in mafiles:

                genes = mfile.split(".")[0].split("_")
                for gene in genes:
                        genetomfile[gene].append(matrixfolder + mfile)
        ...
        for refgene, group in paralogs.items():
                ...
                for nameindex in group:
                        ...
                        for gene in [refgene]:
                                for genefile in genetomfile[gene]:
                                        ...
                                        outfile = "{}/{}_result.txt".format(outputfolder, prefix)
                                        ...
                                        os.system("~/miniconda3/envs/eQTL/bin/Rscript lmm.R {} {} \"{}\" >> {} ".format(genefile , names[nameindex], grouptext, outfile ))
