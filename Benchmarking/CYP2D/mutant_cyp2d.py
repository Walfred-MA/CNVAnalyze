...
#/Users/walfred/anaconda3/bin/python3 $filename -i /Users/walfred/Documents/Marklab/figure4/CYP2D_group1_CYP2D6OOOCYP2D7OOOCYP2D8P.fasta_annotate.fa_lineargraph.gaf -t /Users/walfred/Documents/Marklab/figure4/CYP2D_group1_CYP2D6OOOCYP2D7OOOCYP2D8P.fasta_annotate.fa_types.txt -o ./CYP2D6_groundtruch2.png
...
def makemutant(inputfile, outputfile, typefile,hnames=None,hnames1=None, hnames2 = None):
	...
	with open(inputfile, mode = 'r') as f:
		...
		for line in f:
			...
			if line[0] == 'L':
				...
				if "chr" in line[-1] and name in ['7','8','9'] or 1==1:
	...
	for line in matchtable:
		...
		matchresults[line[1]] = line[2].split(";")[0]
	...
	for i,(name,cigar) in enumerate(zip(names,cigars)):
		...
		segments, variants, highlight_points, exon_points = getsegments(cigar,highlight,exons,pathseqs)
